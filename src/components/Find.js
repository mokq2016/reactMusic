    ...
    return (
      <div className='content-div'>
        <div className='find-menu'>
          <div className={this.state.curTab === 'music' ? 'menu-item actived' : 'menu-item'} onClick={e => this.tabClick('music', e)}>音乐</div>
          <div className={this.state.curTab === 'video' ? 'menu-item actived' : 'menu-item'} onClick={e => this.tabClick('video', e)}>视频</div>
          <div className={this.state.curTab === 'radio' ? 'menu-item actived' : 'menu-item'} onClick={e => this.tabClick('radio', e)}>电台</div>
        </div>
